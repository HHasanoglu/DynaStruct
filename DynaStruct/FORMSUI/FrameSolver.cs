...
namespace FORMSUI
{
    public partial class FrameSolver : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        ...
        {
            foreach (var nodes in _solverHelper.NodeList)
            {
        ...
        private void AddElementsToSeries()
        {
            foreach (var element in _solverHelper.ElementList)
            {
                ...
                series.Points.Add(new SeriesPoint(element.Nodes[0].Xcoord, element.Nodes[0].Ycoord));
                series.Points.Add(new SeriesPoint(element.Nodes[1].Xcoord, element.Nodes[1].Ycoord));
                LineSeriesView lineView = (LineSeriesView)series.View;
